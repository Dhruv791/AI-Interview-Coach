                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      disabled
                      className="w-full bg-slate-950/30 border border-white/5 rounded-xl px-4 py-3 text-slate-500 text-sm cursor-not-allowed outline-none"
                    />
                    <p className="text-[10px] text-slate-550 mt-1.5 font-mono uppercase">Email registry change is restricted</p>
                  </div>
                </div>
                <div className="pt-2">
                  <Magnetic>
